...
(function () {
  ...
  const T = {
    zh: {
      ...
      browse: '浏览…',
      confirm: '确定',
      detecting: '正在检测 dsh 与端口状态…',
      starting: '正在启动 dsh…',
      loadingLine: '正在加载 dsh 界面…',
      reuseLine: '正在连接已有的 dsh 实例…',
    ...
    en: {
      ...
      browse: 'Browse…',
      confirm: 'Confirm',
      detecting: 'Checking dsh and port status…',
      starting: 'Starting dsh…',
      loadingLine: 'Loading the dsh interface…',
      reuseLine: 'Connecting to the existing dsh instance…',
      ...
      validating: 'Validating the dsh path…',
