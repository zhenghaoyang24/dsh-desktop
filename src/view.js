...
const { injectAboutOverlay, injectUpdateCheckOverlay, injectHelpMenu, setHelpBtn } = require("./injected/index");
...
async function loadApp() {
  ...
  try {
    ...
    wc.on("did-finish-load", () => {
      ...
      injectHelpMenu(wc, nativeTheme.shouldUseDarkColors, state.currentLang);
    });
